...
Decorative rotating, bouncing player heads for lobbies and hubs. Place a textured head anywhere,
give it a DecentHolograms text label, and bind left and right click actions to it. One shared
animation task drives every head with client-side interpolation, so hundreds of heads cost almost
nothing.
